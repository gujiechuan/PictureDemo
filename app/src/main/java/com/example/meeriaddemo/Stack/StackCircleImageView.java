 ...
 * </br>
 */
public class StackCircleImageView extends AbsRoundImageView {


    public StackCircleImageView(Context context) {
        this(context, null, 0);
    }

    public StackCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StackCircleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
