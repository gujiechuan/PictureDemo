...
public class AndroidStepActivity extends AppCompatActivity {
    //动态申请健康运动权限
    ...
    public static Intent buildIntent(Context context) {
        Intent intent = new Intent(context, AndroidStepActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStepText = (TextView) findViewById(R.id.tv_step);
